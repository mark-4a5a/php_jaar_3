...
/* CSS styling */
 ...
 .cup { width:132px; height:113px; background-image:url('view/images/cup.png'); float:left; margin:0
20px; }
 .ball { position:absolute; margin-top:72px; margin-left:44px; z-index:-1; width:43px;
height:41px; background:url('view/images/ball.png'); }
 .putdown { margin-top:70px; }
 .putdown .ball { margin-top:72px; }
 .liftup { margin-top:0px; }
 .liftup .ball { margin-top:142px; }
 .player { margin:0 auto; width:92px; height:243px; background:transparent url('view/images/player.png')
no-repeat 0 60px; }
 .clear { clear:both; }
